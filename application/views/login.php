...
<form name="registration" method="post" class="clearfix" action="/welcome.php">
...
<div class="input-field clearfix">
<div class="col-md-12">
<div class="checkbox"><label><input type="checkbox" name="women_club" id="registration_primaryGuest_subscriptions_womensClub"  value="1" />
...
<div class="input-field clearfix">
<div class="col-md-12">
<div class="checkbox"><label><input type="checkbox" name ="redskin_partner" id="registration_primaryGuest_subscriptions_offers"  value="1" />
...
<div class="input-field clearfix">
<div class="col-md-12">
<div class="checkbox"><label><input type="checkbox" name="militery_club" id="registration_primaryGuest_subscriptions_saluteMilitaryAppreciationClub"  value="1" />
