...
<form  method="post"  class="clearfix" action="<?php echo site_url('Welcome'); ?>">
...
<div class="col-md-12">
<div class="checkbox"><label><input type="checkbox" id="registration_primaryGuest_subscriptions_seasonTicketWaitlist" name="usr_signup_type" value="1" />
...
<div class="input-field clearfix">
<div class="col-md-12">
<div class="checkbox"><label><input type="checkbox" name="women_club" id="registration_primaryGuest_subscriptions_womensClub"  value="2" />
...
<div class="input-field clearfix">
<div class="col-md-12">
<div class="checkbox"><label><input type="checkbox" name ="redskin_partner" id="registration_primaryGuest_subscriptions_offers"  value="3" />
...
" id="registration_primaryGuest_subscriptions_saluteMilitaryAppreciationClub"  value="4" />
...
<input type="submit" name="getregisterd" value="Submit" a href ="">
</div>
</div>
<div class="hide">
